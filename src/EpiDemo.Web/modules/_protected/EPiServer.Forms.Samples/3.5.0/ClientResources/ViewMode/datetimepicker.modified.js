...
(function ($) {
    ...
    function DateTimePicker() {
        ...
        this.regional["no"] = { // Default regional settings
            closeText: "Ferdig", // Display text for close link
            prevText: "Forrige", // Display text for previous month link
            nextText: "Neste", // Display text for next month link
            currentText: "I dag", // Display text for current month link
            monthNames: ["Januar", "Februar", "Mars", "April", "Mai", "Juni",
                "Juli", "August", "September", "Oktober", "November", "Desember"], // Names of months for drop-down and formatting
            monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"], // For formatting
            ...
            weekHeader: "Uke", // Column header for week of the year
                    ...
                    for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        ...
                        for (dow = 0; dow < 7; dow++) { // create date picker days
                            ...
                            tbody += "<td class='" +
                                ...
                                (printDate.getTime() === selectedDate.getTime() ? " ui-state-highlight" : "") +
