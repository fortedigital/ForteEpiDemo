(function ($) {
    ...
    var _utilsSvc = epi.EPiServer.Forms.Utils,
        ...
        language = document.documentElement.lang || navigator.language || navigator.userLanguage, // on iOS naviagtor.language is in lower case (ex: en-us)
    ...
    $.extend(true, epi.EPiServer.Forms, {
        ...
        CustomBindingElements: {
            "EPiServer.Forms.Samples.Implementation.Elements.DateTimeElementBlock": function (elementInfo, val) {
                ...
                var picker = { settings: { dateFormat: dateFormat } },
                    ...
                    timeString = language ==="no"? dateTime.toLocaleString('nb-no', { hour: '2-digit', minute: '2-digit', hour12: false }) : dateTime.toLocaleString('en-us', { hour: '2-digit', minute: '2-digit', hour12: true }),  
                    timeStringWithLeadingZero = timeString.slice(-8); // with format "hh:mm tt", toLocaleString return hour without leading zero
        ...
        Extension: {
            ...
            showSummarizedText: function (data, workingFormInfo, ignoreFields, shouldBeHiddenKeys) {
                ...
                var localizedResources = epi.EPiServer.Forms.Samples.LocalizedResources[language];

                var confirmationResources = localizedResources ? localizedResources.ConfirmationDialog : epi.EPiServer.Forms.LocalizedResources.samples.confirmationdialog;
